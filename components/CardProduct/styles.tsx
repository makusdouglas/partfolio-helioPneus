...
max-width: 300px;
/* max-height: 500px; */
background: ${props => lighten(0.05, props.theme.color.bgSecondary)};
border-radius: 10px;
position: relative;
overflow: hidden;
padding-bottom: 40px;
...
span {
    display: block;
    color: ${props => props.inStock? props.theme.color.success: props.theme.color.danger};
...
export const ButtomFooter = styled.a<LinkButtomProps>`
    ...
    &:hover {
        ...
        color: ${props => lighten(0.2, props.theme.color.text)};
    }
    `
